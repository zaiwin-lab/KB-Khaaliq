...
(function () {
  ...
  const T = {
    en: {
      ...
      "hero.tag": "Representing District Kuching · 45 Districts of Sarawak",
      "hero.title": "I'm helping <span class=\"accent\">100 Sarawak businesses</span> go digital.",
      "hero.sub": "My name is Abdul Khaaliq bin Ahmad. As a Sarawak Digital Champion, my commitment is simple: activate 100 new business websites and help local entrepreneurs get found, get trusted, and grow online.",
      ...
      "offer.was": "Usual RM1,000 · <strong>50% off</strong> activation to make digital presence accessible for local entrepreneurs.",
      ...
      "foot.initiative": "Initiative", "foot.partners": "Partners",
      ...
      "f.links.lead": "Website, Facebook, Instagram, TikTok, Shopee, Google, anything. Paste them all in one go, any order. Our AI sorts and labels each one.",
      "f.files.title": "Drop your files in one place",
      "f.files.lead": "Logo, business profile, product photos, certificates, PDFs. Drop everything together, our AI files each one into the right category.",
    ...
    bm: {
      ...
      "hero.tag": "Mewakili Daerah Kuching · 45 Daerah Sarawak",
      "hero.title": "Saya membantu <span class=\"accent\">100 perniagaan Sarawak</span> mendigital.",
      "hero.sub": "Nama saya Abdul Khaaliq bin Ahmad. Sebagai Sarawak Digital Champion, komitmen saya mudah: mengaktifkan 100 laman web perniagaan baharu dan membantu usahawan tempatan ditemui, dipercayai, dan berkembang dalam talian.",
      ...
      "offer.was": "Biasanya RM1,000 · <strong>diskaun 50%</strong> pengaktifan supaya kehadiran digital lebih mampu milik untuk usahawan tempatan.",
      ...
      "foot.initiative": "Inisiatif", "foot.partners": "Rakan Kongsi",
      ...
      "f.links.lead": "Laman web, Facebook, Instagram, TikTok, Shopee, Google, apa sahaja. Tampal kesemuanya sekali gus, mana-mana susunan. AI kami menyusun dan melabel setiap satu.",
      "f.files.title": "Lepas fail anda di satu tempat",
      "f.files.lead": "Logo, profil perniagaan, gambar produk, sijil, PDF. Lepas semuanya bersama, AI kami menyusun setiap satu ke kategori betul.",
    ...
    zh: {
      ...
      "hero.tag": "代表古晋县 · 砂拉越45个县",
      "hero.title": "我正帮助 <span class=\"accent\">100家砂拉越企业</span> 迈向数字化。",
      "hero.sub": "我是 Abdul Khaaliq bin Ahmad。作为砂拉越数字大使，我的承诺很简单：启动100个新企业网站，帮助本地创业者被看见、被信任、在线上成长。",
      ...
      "offer.was": "原价 RM1,000 · 启动 <strong>5折优惠</strong>，让本地创业者更易拥有数字存在。",
      "offer.claim": "领取您的启动 →",
      ...
      "foot.initiative": "倡议", "foot.partners": "合作伙伴",
      ...
      "f.links.lead": "网站、Facebook、Instagram、TikTok、Shopee、Google，任何链接。一次粘贴全部，顺序不限。我们的AI会逐一分类并标注。",
      "f.files.title": "把文件集中放一处",
      "f.files.lead": "标志、企业简介、产品照片、证书、PDF。一起放入，我们的AI会逐一归类。",
    ...
    ib: {
      ...
      "hero.tag": "Madahka Daerah Kuching · 45 Daerah Sarawak",
      "hero.title": "Aku nulung <span class=\"accent\">100 pengawa Sarawak</span> nyadi digital.",
      "hero.sub": "Nama aku Abdul Khaaliq bin Ahmad. Nyadi Sarawak Digital Champion, semaya aku mudah: ngidupka 100 laman web pengawa baru lalu nulung orang bisnis ditemu, dipechaya, lalu mansang ba online.",
      ...
      "offer.was": "Biasa RM1,000 · <strong>diskaun 50%</strong> pengidup ngambika pengidup digital senang ulih orang bisnis menua.",
      ...
      "foot.initiative": "Inisiatif", "foot.partners": "Kaban",
      ...
      "f.links.lead": "Laman web, Facebook, Instagram, TikTok, Shopee, Google, sebarang. Tampal semua sekali, sebarang urut. AI kami nyusun lalu nge-label genap siti.",
