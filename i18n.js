...
(function () {
  ...
  const T = {
    en: {
      ...
      "hero.sub": "My name is Abdul Khaaliq bin Ahmad. As a Sarawak Digital Champion candidate, my commitment is simple: activate 100 new business websites and help local entrepreneurs get found, get trusted, and grow online.",
    ...
    bm: {
      ...
      "hero.sub": "Nama saya Abdul Khaaliq bin Ahmad. Sebagai calon Sarawak Digital Champion, komitmen saya mudah: mengaktifkan 100 laman web perniagaan baharu dan membantu usahawan tempatan ditemui, dipercayai, dan berkembang dalam talian.",
    ...
    zh: {
      ...
      "hero.sub": "我是 Abdul Khaaliq bin Ahmad。作为砂拉越数字大使候选人，我的承诺很简单：启动100个新企业网站，帮助本地创业者被看见、被信任、在线上成长。",
    ...
    ib: {
      ...
      "hero.sub": "Nama aku Abdul Khaaliq bin Ahmad. Nyadi calon Sarawak Digital Champion, semaya aku mudah: ngidupka 100 laman web pengawa baru lalu nulung orang bisnis ditemu, dipechaya, lalu mansang ba online.",
