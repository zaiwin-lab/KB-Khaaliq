...
(function () {
  ...
  const T = {
    en: {
      ...
      "verify.title": "Sarawak Digital Champion Programme",
      "verify.sub": "Verify candidacy on the SDEC website",
      "verify.chip": "On SDEC",
      "portrait.role": "Sarawak Digital Champion Candidate · Kuching",
      "brand.tag": "Sarawak Digital Champion Candidate · Kuching",
    ...
    bm: {
      ...
      "verify.title": "Program Sarawak Digital Champion",
      "verify.sub": "Sahkan pencalonan di laman web SDEC",
      "verify.chip": "Di SDEC",
      "portrait.role": "Calon Sarawak Digital Champion · Kuching",
      "brand.tag": "Calon Sarawak Digital Champion · Kuching",
    ...
    zh: {
      ...
      "hero.trust": "倡议方",
      "verify.title": "砂拉越数字大使计划",
      "verify.sub": "在 SDEC 官网验证候选资格",
      "verify.chip": "见 SDEC",
      "portrait.role": "砂拉越数字大使候选人 · 古晋",
      "brand.tag": "砂拉越数字大使候选人 · 古晋",
    ...
    ib: {
      ...
      "verify.title": "Program Sarawak Digital Champion",
      "verify.sub": "Meretika pencalon ba laman web SDEC",
      "verify.chip": "Ba SDEC",
      "portrait.role": "Calon Sarawak Digital Champion · Kuching",
      "brand.tag": "Calon Sarawak Digital Champion · Kuching",
