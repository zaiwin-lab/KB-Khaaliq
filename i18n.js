...
(function () {
  ...
  const T = {
    en: {
      ...
      "foot.programIntro": "Sarawak Digital Champion (SDC) is a digital-empowerment program organized by:",
      "foot.independent": "This website is an independent initiative by an SDC Candidate.",
    ...
    bm: {
      ...
      "foot.programIntro": "Sarawak Digital Champion (SDC) ialah program pemerkasaan digital yang dianjurkan oleh:",
      "foot.independent": "Laman web ini ialah inisiatif bebas oleh seorang Calon SDC.",
    ...
    zh: {
      ...
      "foot.programIntro": "砂拉越数字大使（SDC）是由以下机构主办的数字赋能计划：",
      "foot.independent": "本网站为一名 SDC 候选人的独立倡议。",
    ...
    ib: {
      ...
      "foot.initiative": "Inisiatif", "foot.partners": "Program SDC",
      "foot.programIntro": "Sarawak Digital Champion (SDC) nya program pemansang digital ti diatur ulih:",
      "foot.independent": "Laman web tu nya inisiatif bebas ari siku Calon SDC.",
